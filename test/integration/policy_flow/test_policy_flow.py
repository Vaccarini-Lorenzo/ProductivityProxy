                            ...
                            "policies": [
                                {
                                    ...
                                    "steps": [
                                        ...
                                        {"id": "is-reddit", "kind": "operator", "type": "if", "params": {"path": "match"}},
                                        ...
                                        {"id": "is-over", "kind": "operator", "type": "if", "params": {"path": "over_limit"}},
                                    ...
                                    "edges": [
                                        ...
                                        {"from": "is-reddit", "output": "true", "to": "track"},
                                        {"from": "is-reddit", "output": "false", "to": "end"},
                                        {"from": "track", "output": "next", "to": "limit"},
                                        {"from": "limit", "output": "next", "to": "is-over"},
                                        {"from": "is-over", "output": "true", "to": "block"},
                                        {"from": "is-over", "output": "false", "to": "end"},
                                    ],
                                }
                            ],
                        }
