...
- Graph-specific CSS lives in `style/graph.css` and policy/editor surrounding rules in `style/policy.css` (the global React styling rule is described in [React Dashboard](react-dashboard.md#styling)).
